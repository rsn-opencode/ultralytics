...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`DistanceCalculation`](#ultralytics.solutions.distance_calculation.DistanceCalculation)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`DistanceCalculation.mouse_event_for_distance`](#ultralytics.solutions.distance_calculation.DistanceCalculation.mouse_event_for_distance)
        - [`DistanceCalculation.process`](#ultralytics.solutions.distance_calculation.DistanceCalculation.process)


## Class `ultralytics.solutions.distance_calculation.DistanceCalculation` {#ultralytics.solutions.distance\_calculation.DistanceCalculation}
...
| Name | Description |
| --- | --- |
| [`mouse_event_for_distance`](#ultralytics.solutions.distance_calculation.DistanceCalculation.mouse_event_for_distance) | Handle mouse events to select regions in a real-time video stream for distance calculation. |
| [`process`](#ultralytics.solutions.distance_calculation.DistanceCalculation.process) | Process a video frame and calculate the distance between two selected bounding boxes. |
...
<details>
<summary>Source code in <code>ultralytics/solutions/distance_calculation.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/distance_calculation.py#L12-L123"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.solutions.distance_calculation.DistanceCalculation.mouse_event_for_distance` {#ultralytics.solutions.distance\_calculation.DistanceCalculation.mouse\_event\_for\_distance}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/distance_calculation.py#L44-L67"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def mouse_event_for_distance(self, event: int, x: int, y: int, flags: int, param: Any) -> None:
    """Handle mouse events to select regions in a real-time video stream for distance calculation.
...
### Method `ultralytics.solutions.distance_calculation.DistanceCalculation.process` {#ultralytics.solutions.distance\_calculation.DistanceCalculation.process}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/distance_calculation.py#L69-L123"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def process(self, im0) -> SolutionResults:
    """Process a video frame and calculate the distance between two selected bounding boxes.
