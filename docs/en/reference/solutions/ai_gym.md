...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`AIGym`](#ultralytics.solutions.ai_gym.AIGym)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`AIGym.process`](#ultralytics.solutions.ai_gym.AIGym.process)


## Class `ultralytics.solutions.ai_gym.AIGym` {#ultralytics.solutions.ai\_gym.AIGym}
...
| --- | --- | --- | --- |
| `**kwargs` | `Any` | Keyword arguments passed to the parent class constructor including:<br>    - model (str): Model name or path, defaults to "yolo26n-pose.pt". | *required* |
...
| Name | Description |
| --- | --- |
| [`process`](#ultralytics.solutions.ai_gym.AIGym.process) | Monitor workouts using Ultralytics YOLO Pose Model. |
...
<details>
<summary>Source code in <code>ultralytics/solutions/ai_gym.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/ai_gym.py#L9-L108"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.solutions.ai_gym.AIGym.process` {#ultralytics.solutions.ai\_gym.AIGym.process}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/ai_gym.py#L49-L108"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def process(self, im0) -> SolutionResults:
    """Monitor workouts using Ultralytics YOLO Pose Model.
    ...
    Returns:
        (SolutionResults): Contains processed image `plot_im`, 'workout_count' (list of completed reps), 'workout_stage'
            (list of current stages), 'workout_angle' (list of angles), and 'total_tracks' (total number of
            tracked individuals).
