...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`ObjectBlurrer`](#ultralytics.solutions.object_blurrer.ObjectBlurrer)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`ObjectBlurrer.process`](#ultralytics.solutions.object_blurrer.ObjectBlurrer.process)


## Class `ultralytics.solutions.object_blurrer.ObjectBlurrer` {#ultralytics.solutions.object\_blurrer.ObjectBlurrer}
...
| --- | --- | --- | --- |
| `**kwargs` | `Any` | Keyword arguments passed to the parent class and for configuration including:<br>    - blur_ratio (float): Intensity of the blur effect (0.1-1.0, default=0.5). | *required* |
...
| Name | Description |
| --- | --- |
| [`process`](#ultralytics.solutions.object_blurrer.ObjectBlurrer.process) | Apply a blurring effect to detected objects in the input image. |
...
<details>
<summary>Source code in <code>ultralytics/solutions/object_blurrer.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/object_blurrer.py#L12-L89"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.solutions.object_blurrer.ObjectBlurrer.process` {#ultralytics.solutions.object\_blurrer.ObjectBlurrer.process}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/object_blurrer.py#L49-L89"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def process(self, im0) -> SolutionResults:
    """Apply a blurring effect to detected objects in the input image.
