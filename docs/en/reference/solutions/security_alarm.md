...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`SecurityAlarm`](#ultralytics.solutions.security_alarm.SecurityAlarm)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`SecurityAlarm.authenticate`](#ultralytics.solutions.security_alarm.SecurityAlarm.authenticate)
        - [`SecurityAlarm.send_email`](#ultralytics.solutions.security_alarm.SecurityAlarm.send_email)
        - [`SecurityAlarm.process`](#ultralytics.solutions.security_alarm.SecurityAlarm.process)


## Class `ultralytics.solutions.security_alarm.SecurityAlarm` {#ultralytics.solutions.security\_alarm.SecurityAlarm}
...
| Name | Description |
| --- | --- |
| [`authenticate`](#ultralytics.solutions.security_alarm.SecurityAlarm.authenticate) | Authenticate the email server for sending alert notifications. |
| [`process`](#ultralytics.solutions.security_alarm.SecurityAlarm.process) | Monitor the frame, process object detections, and trigger alerts if thresholds are met. |
| [`send_email`](#ultralytics.solutions.security_alarm.SecurityAlarm.send_email) | Send an email notification with an image attachment indicating the number of objects detected. |
...
<details>
<summary>Source code in <code>ultralytics/solutions/security_alarm.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/security_alarm.py#L10-L151"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.solutions.security_alarm.SecurityAlarm.authenticate` {#ultralytics.solutions.security\_alarm.SecurityAlarm.authenticate}
...
| `password` | `str` | Password for the sender's email account. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/security_alarm.py#L49-L69"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def authenticate(self, from_email: str, password: str, to_email: str) -> None:
    """Authenticate the email server for sending alert notifications.
...
### Method `ultralytics.solutions.security_alarm.SecurityAlarm.process` {#ultralytics.solutions.security\_alarm.SecurityAlarm.process}
...
This method processes the input frame, extracts detections, annotates the frame with bounding boxes, and sends an email notification if the number of detected objects meets or exceeds the specified threshold and an alert has not already been sent.

**Args**

| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `im0` | `np.ndarray` | The input image or frame to be processed and annotated. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/security_alarm.py#L115-L151"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def process(self, im0) -> SolutionResults:
    """Monitor the frame, process object detections, and trigger alerts if thresholds are met.
...
### Method `ultralytics.solutions.security_alarm.SecurityAlarm.send_email` {#ultralytics.solutions.security\_alarm.SecurityAlarm.send\_email}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `im0` | `np.ndarray` | The input image or frame to be attached to the email. | *required* |
| `records` | `int, optional` | The number of detected objects to be included in the email message. | `5` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/solutions/security_alarm.py#L71-L113"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def send_email(self, im0, records: int = 5) -> None:
    """Send an email notification with an image attachment indicating the number of objects detected.
