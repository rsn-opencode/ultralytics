...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`Tuner`](#ultralytics.engine.tuner.Tuner)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`Tuner._connect`](#ultralytics.engine.tuner.Tuner._connect)
        - [`Tuner._init_mongodb`](#ultralytics.engine.tuner.Tuner._init_mongodb)
        - [`Tuner._get_mongodb_results`](#ultralytics.engine.tuner.Tuner._get_mongodb_results)
        - [`Tuner._save_to_mongodb`](#ultralytics.engine.tuner.Tuner._save_to_mongodb)
        - [`Tuner._sync_mongodb_to_csv`](#ultralytics.engine.tuner.Tuner._sync_mongodb_to_csv)
        - [`Tuner._crossover`](#ultralytics.engine.tuner.Tuner._crossover)
        - [`Tuner._mutate`](#ultralytics.engine.tuner.Tuner._mutate)
        - [`Tuner.__call__`](#ultralytics.engine.tuner.Tuner.__call__)


## Class `ultralytics.engine.tuner.Tuner` {#ultralytics.engine.tuner.Tuner}

```python
Tuner(self, args = DEFAULT_CFG, _callbacks: list | None = None)
```
...
| `_callbacks` | `dict | None, optional` | Callback functions to be executed during tuning. | `None` |
...
| Name | Description |
| --- | --- |
| [`__call__`](#ultralytics.engine.tuner.Tuner.__call__) | Execute the hyperparameter evolution process when the Tuner instance is called. |
| [`_connect`](#ultralytics.engine.tuner.Tuner._connect) | Create MongoDB client with exponential backoff retry on connection failures. |
| [`_crossover`](#ultralytics.engine.tuner.Tuner._crossover) | BLX-α crossover from up to top-k parents (x[:,0]=fitness, rest=genes). |
| [`_get_mongodb_results`](#ultralytics.engine.tuner.Tuner._get_mongodb_results) | Get top N results from MongoDB sorted by fitness. |
| [`_init_mongodb`](#ultralytics.engine.tuner.Tuner._init_mongodb) | Initialize MongoDB connection for distributed tuning. |
| [`_mutate`](#ultralytics.engine.tuner.Tuner._mutate) | Mutate hyperparameters based on bounds and scaling factors specified in `self.space`. |
| [`_save_to_mongodb`](#ultralytics.engine.tuner.Tuner._save_to_mongodb) | Save results to MongoDB with proper type conversion. |
| [`_sync_mongodb_to_csv`](#ultralytics.engine.tuner.Tuner._sync_mongodb_to_csv) | Sync MongoDB results to CSV for plotting compatibility. |
...
<details>
<summary>Source code in <code>ultralytics/engine/tuner.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L36-L457"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
class Tuner:
    """A class for hyperparameter tuning of YOLO models.
...
### Method `ultralytics.engine.tuner.Tuner.__call__` {#ultralytics.engine.tuner.Tuner.\_\_call\_\_}
...
| `cleanup` | `bool` | Whether to delete iteration weights to reduce storage space during tuning. | `True` |

<details>
<summary>Source code in <code>ultralytics/engine/tuner.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L350-L457"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def __call__(self, iterations: int = 10, cleanup: bool = True):
    """Execute the hyperparameter evolution process when the Tuner instance is called.
...
### Method `ultralytics.engine.tuner.Tuner._connect` {#ultralytics.engine.tuner.Tuner.\_connect}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `uri` | `str` | MongoDB connection string with credentials and cluster information. | `"mongodb+srv://username:password@cluster.mongodb.net/"` |
| `max_retries` | `int` | Maximum number of connection attempts before giving up. | `3` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L142-L180"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _connect(self, uri: str = "mongodb+srv://username:password@cluster.mongodb.net/", max_retries: int = 3):
    """Create MongoDB client with exponential backoff retry on connection failures.
...
### Method `ultralytics.engine.tuner.Tuner._crossover` {#ultralytics.engine.tuner.Tuner.\_crossover}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L265-L278"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def _crossover(x: np.ndarray, alpha: float = 0.2, k: int = 9) -> np.ndarray:
    """BLX-α crossover from up to top-k parents (x[:,0]=fitness, rest=genes)."""
...
### Method `ultralytics.engine.tuner.Tuner._get_mongodb_results` {#ultralytics.engine.tuner.Tuner.\_get\_mongodb\_results}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `n` | `int` | Number of top results to retrieve. | `5` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L203-L215"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _get_mongodb_results(self, n: int = 5) -> list:
    """Get top N results from MongoDB sorted by fitness.
...
### Method `ultralytics.engine.tuner.Tuner._init_mongodb` {#ultralytics.engine.tuner.Tuner.\_init\_mongodb}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L182-L201"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _init_mongodb(self, mongodb_uri="", mongodb_db="", mongodb_collection=""):
    """Initialize MongoDB connection for distributed tuning.
...
### Method `ultralytics.engine.tuner.Tuner._mutate` {#ultralytics.engine.tuner.Tuner.\_mutate}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `n` | `int` | Number of top parents to consider. | `9` |
| `mutation` | `float` | Probability of a parameter mutation in any given iteration. | `0.5` |
| `sigma` | `float` | Standard deviation for Gaussian random number generator. | `0.2` |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L280-L348"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _mutate(
    self,
    n: int = 9,
...
### Method `ultralytics.engine.tuner.Tuner._save_to_mongodb` {#ultralytics.engine.tuner.Tuner.\_save\_to\_mongodb}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `fitness` | `float` | Fitness score achieved with these hyperparameters. | *required* |
| `hyperparameters` | `dict[str, float]` | Dictionary of hyperparameter values. | *required* |
| `metrics` | `dict` | Complete training metrics dictionary (mAP, precision, recall, losses, etc.). | *required* |
| `iteration` | `int` | Current iteration number. | *required* |

<details>
<summary>Source code in <code>ultralytics/engine/tuner.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L217-L237"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _save_to_mongodb(self, fitness: float, hyperparameters: dict[str, float], metrics: dict, iteration: int):
    """Save results to MongoDB with proper type conversion.
...
### Method `ultralytics.engine.tuner.Tuner._sync_mongodb_to_csv` {#ultralytics.engine.tuner.Tuner.\_sync\_mongodb\_to\_csv}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/tuner.py#L239-L262"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _sync_mongodb_to_csv(self):
    """Sync MongoDB results to CSV for plotting compatibility.
