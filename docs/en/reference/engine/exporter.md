...
!!! abstract "Summary"
    ...
    === "<span class="doc-kind doc-kind-class">Classes</span>"
        ...
        - [`Exporter`](#ultralytics.engine.exporter.Exporter)
        - [`IOSDetectModel`](#ultralytics.engine.exporter.IOSDetectModel)
        - [`NMSModel`](#ultralytics.engine.exporter.NMSModel)

    === "<span class="doc-kind doc-kind-method">Methods</span>"

        - [`Exporter.__call__`](#ultralytics.engine.exporter.Exporter.__call__)
        - [`Exporter.get_int8_calibration_dataloader`](#ultralytics.engine.exporter.Exporter.get_int8_calibration_dataloader)
        - [`Exporter.export_torchscript`](#ultralytics.engine.exporter.Exporter.export_torchscript)
        - [`Exporter.export_onnx`](#ultralytics.engine.exporter.Exporter.export_onnx)
        - [`Exporter.export_openvino`](#ultralytics.engine.exporter.Exporter.export_openvino)
        - [`Exporter.export_paddle`](#ultralytics.engine.exporter.Exporter.export_paddle)
        - [`Exporter.export_mnn`](#ultralytics.engine.exporter.Exporter.export_mnn)
        - [`Exporter.export_ncnn`](#ultralytics.engine.exporter.Exporter.export_ncnn)
        - [`Exporter.export_coreml`](#ultralytics.engine.exporter.Exporter.export_coreml)
        - [`Exporter.export_engine`](#ultralytics.engine.exporter.Exporter.export_engine)
        - [`Exporter.export_saved_model`](#ultralytics.engine.exporter.Exporter.export_saved_model)
        - [`Exporter.export_pb`](#ultralytics.engine.exporter.Exporter.export_pb)
        - [`Exporter.export_tflite`](#ultralytics.engine.exporter.Exporter.export_tflite)
        - [`Exporter.export_axelera`](#ultralytics.engine.exporter.Exporter.export_axelera)
        - [`Exporter.export_executorch`](#ultralytics.engine.exporter.Exporter.export_executorch)
        - [`Exporter.export_edgetpu`](#ultralytics.engine.exporter.Exporter.export_edgetpu)
        - [`Exporter.export_tfjs`](#ultralytics.engine.exporter.Exporter.export_tfjs)
        - [`Exporter.export_rknn`](#ultralytics.engine.exporter.Exporter.export_rknn)
        - [`Exporter.export_imx`](#ultralytics.engine.exporter.Exporter.export_imx)
        - [`Exporter._add_tflite_metadata`](#ultralytics.engine.exporter.Exporter._add_tflite_metadata)
        - [`Exporter._pipeline_coreml`](#ultralytics.engine.exporter.Exporter._pipeline_coreml)
        - [`Exporter._transform_fn`](#ultralytics.engine.exporter.Exporter._transform_fn)
        - [`Exporter.add_callback`](#ultralytics.engine.exporter.Exporter.add_callback)
        - [`Exporter.run_callbacks`](#ultralytics.engine.exporter.Exporter.run_callbacks)
        - [`IOSDetectModel.forward`](#ultralytics.engine.exporter.IOSDetectModel.forward)
        - [`NMSModel.forward`](#ultralytics.engine.exporter.NMSModel.forward)

    === "<span class="doc-kind doc-kind-function">Functions</span>"

        - [`export_formats`](#ultralytics.engine.exporter.export_formats)
        - [`best_onnx_opset`](#ultralytics.engine.exporter.best_onnx_opset)
        - [`validate_args`](#ultralytics.engine.exporter.validate_args)
        - [`try_export`](#ultralytics.engine.exporter.try_export)
...
| --- | --- | --- | --- |
| `cfg` | `str | Path | dict | SimpleNamespace, optional` | Configuration file path or configuration object. | `DEFAULT_CFG` |
...
| Name | Description |
| --- | --- |
| [`__call__`](#ultralytics.engine.exporter.Exporter.__call__) | Export a model and return the final exported path as a string. |
| [`_add_tflite_metadata`](#ultralytics.engine.exporter.Exporter._add_tflite_metadata) | Add metadata to *.tflite models per https://ai.google.dev/edge/litert/models/metadata. |
| [`_pipeline_coreml`](#ultralytics.engine.exporter.Exporter._pipeline_coreml) | Create CoreML pipeline with NMS for YOLO detection models. |
| [`_transform_fn`](#ultralytics.engine.exporter.Exporter._transform_fn) | The transformation function for Axelera/OpenVINO quantization preprocessing. |
| [`add_callback`](#ultralytics.engine.exporter.Exporter.add_callback) | Append the given callback to the specified event. |
| [`export_axelera`](#ultralytics.engine.exporter.Exporter.export_axelera) | Export YOLO model to Axelera format. |
| [`export_coreml`](#ultralytics.engine.exporter.Exporter.export_coreml) | Export YOLO model to CoreML format. |
| [`export_edgetpu`](#ultralytics.engine.exporter.Exporter.export_edgetpu) | Export YOLO model to Edge TPU format https://coral.ai/docs/edgetpu/models-intro/. |
| [`export_engine`](#ultralytics.engine.exporter.Exporter.export_engine) | Export YOLO model to TensorRT format https://developer.nvidia.com/tensorrt. |
| [`export_executorch`](#ultralytics.engine.exporter.Exporter.export_executorch) | Export YOLO model to ExecuTorch *.pte format. |
| [`export_imx`](#ultralytics.engine.exporter.Exporter.export_imx) | Export YOLO model to IMX format. |
| [`export_mnn`](#ultralytics.engine.exporter.Exporter.export_mnn) | Export YOLO model to MNN format using MNN https://github.com/alibaba/MNN. |
| [`export_ncnn`](#ultralytics.engine.exporter.Exporter.export_ncnn) | Export YOLO model to NCNN format using PNNX https://github.com/pnnx/pnnx. |
| [`export_onnx`](#ultralytics.engine.exporter.Exporter.export_onnx) | Export YOLO model to ONNX format. |
| [`export_openvino`](#ultralytics.engine.exporter.Exporter.export_openvino) | Export YOLO model to OpenVINO format. |
| [`export_paddle`](#ultralytics.engine.exporter.Exporter.export_paddle) | Export YOLO model to PaddlePaddle format. |
| [`export_pb`](#ultralytics.engine.exporter.Exporter.export_pb) | Export YOLO model to TensorFlow GraphDef *.pb format https://github.com/leimao/Frozen-Graph-TensorFlow. |
| [`export_rknn`](#ultralytics.engine.exporter.Exporter.export_rknn) | Export YOLO model to RKNN format. |
| [`export_saved_model`](#ultralytics.engine.exporter.Exporter.export_saved_model) | Export YOLO model to TensorFlow SavedModel format. |
| [`export_tfjs`](#ultralytics.engine.exporter.Exporter.export_tfjs) | Export YOLO model to TensorFlow.js format. |
| [`export_tflite`](#ultralytics.engine.exporter.Exporter.export_tflite) | Export YOLO model to TensorFlow Lite format. |
| [`export_torchscript`](#ultralytics.engine.exporter.Exporter.export_torchscript) | Export YOLO model to TorchScript format. |
| [`get_int8_calibration_dataloader`](#ultralytics.engine.exporter.Exporter.get_int8_calibration_dataloader) | Build and return a dataloader for calibration of INT8 models. |
| [`run_callbacks`](#ultralytics.engine.exporter.Exporter.run_callbacks) | Execute all callbacks for a given event. |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L257-L1460"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
class Exporter:
    """A class for exporting YOLO models to various formats.
...
### Method `ultralytics.engine.exporter.Exporter.__call__` {#ultralytics.engine.exporter.Exporter.\_\_call\_\_}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L321-L636"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def __call__(self, model=None) -> str:
    """Export a model and return the final exported path as a string.
...
### Method `ultralytics.engine.exporter.Exporter._add_tflite_metadata` {#ultralytics.engine.exporter.Exporter.\_add\_tflite\_metadata}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1343-L1348"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _add_tflite_metadata(self, file):
    """Add metadata to *.tflite models per https://ai.google.dev/edge/litert/models/metadata."""
    import zipfile
...
### Method `ultralytics.engine.exporter.Exporter._pipeline_coreml` {#ultralytics.engine.exporter.Exporter.\_pipeline\_coreml}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1350-L1443"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def _pipeline_coreml(self, model, weights_dir=None, prefix=colorstr("CoreML Pipeline:")):
    """Create CoreML pipeline with NMS for YOLO detection models."""
...
### Method `ultralytics.engine.exporter.Exporter._transform_fn` {#ultralytics.engine.exporter.Exporter.\_transform\_fn}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1446-L1451"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@staticmethod
def _transform_fn(data_item) -> np.ndarray:
    """The transformation function for Axelera/OpenVINO quantization preprocessing."""
...
### Method `ultralytics.engine.exporter.Exporter.add_callback` {#ultralytics.engine.exporter.Exporter.add\_callback}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1453-L1455"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def add_callback(self, event: str, callback):
    """Append the given callback to the specified event."""
...
### Method `ultralytics.engine.exporter.Exporter.export_axelera` {#ultralytics.engine.exporter.Exporter.export\_axelera}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `prefix` |  |  | `colorstr("Axelera:")` |

<details>
<summary>Source code in <code>ultralytics/engine/exporter.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1137-L1201"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@try_export
def export_axelera(self, prefix=colorstr("Axelera:")):
    """Export YOLO model to Axelera format."""
...
### Method `ultralytics.engine.exporter.Exporter.export_coreml` {#ultralytics.engine.exporter.Exporter.export\_coreml}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L910-L1003"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@try_export
def export_coreml(self, prefix=colorstr("CoreML:")):
    """Export YOLO model to CoreML format."""
...
### Method `ultralytics.engine.exporter.Exporter.export_edgetpu` {#ultralytics.engine.exporter.Exporter.export\_edgetpu}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1234-L1255"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@try_export
def export_edgetpu(self, tflite_model="", prefix=colorstr("Edge TPU:")):
    """Export YOLO model to Edge TPU format https://coral.ai/docs/edgetpu/models-intro/."""
...
### Method `ultralytics.engine.exporter.Exporter.export_engine` {#ultralytics.engine.exporter.Exporter.export\_engine}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1006-L1043"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@try_export
def export_engine(self, dla=None, prefix=colorstr("TensorRT:")):
    """Export YOLO model to TensorRT format https://developer.nvidia.com/tensorrt."""
...
### Method `ultralytics.engine.exporter.Exporter.export_executorch` {#ultralytics.engine.exporter.Exporter.export\_executorch}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1204-L1231"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@try_export
def export_executorch(self, prefix=colorstr("ExecuTorch:")):
    """Export YOLO model to ExecuTorch *.pte format."""
...
### Method `ultralytics.engine.exporter.Exporter.export_imx` {#ultralytics.engine.exporter.Exporter.export\_imx}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1297-L1341"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@try_export
def export_imx(self, prefix=colorstr("IMX:")):
    """Export YOLO model to IMX format."""
...
### Method `ultralytics.engine.exporter.Exporter.export_mnn` {#ultralytics.engine.exporter.Exporter.export\_mnn}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L850-L873"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@try_export
def export_mnn(self, prefix=colorstr("MNN:")):
    """Export YOLO model to MNN format using MNN https://github.com/alibaba/MNN."""
...
### Method `ultralytics.engine.exporter.Exporter.export_ncnn` {#ultralytics.engine.exporter.Exporter.export\_ncnn}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L876-L907"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@try_export
def export_ncnn(self, prefix=colorstr("NCNN:")):
    """Export YOLO model to NCNN format using PNNX https://github.com/pnnx/pnnx."""
...
### Method `ultralytics.engine.exporter.Exporter.export_onnx` {#ultralytics.engine.exporter.Exporter.export\_onnx}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L681-L756"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@try_export
def export_onnx(self, prefix=colorstr("ONNX:")):
    """Export YOLO model to ONNX format."""
...
### Method `ultralytics.engine.exporter.Exporter.export_openvino` {#ultralytics.engine.exporter.Exporter.export\_openvino}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L759-L823"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@try_export
def export_openvino(self, prefix=colorstr("OpenVINO:")):
    """Export YOLO model to OpenVINO format."""
...
### Method `ultralytics.engine.exporter.Exporter.export_paddle` {#ultralytics.engine.exporter.Exporter.export\_paddle}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L826-L847"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@try_export
def export_paddle(self, prefix=colorstr("PaddlePaddle:")):
    """Export YOLO model to PaddlePaddle format."""
...
### Method `ultralytics.engine.exporter.Exporter.export_pb` {#ultralytics.engine.exporter.Exporter.export\_pb}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1114-L1118"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@try_export
def export_pb(self, keras_model, prefix=colorstr("TensorFlow GraphDef:")):
    """Export YOLO model to TensorFlow GraphDef *.pb format https://github.com/leimao/Frozen-Graph-TensorFlow."""
...
### Method `ultralytics.engine.exporter.Exporter.export_rknn` {#ultralytics.engine.exporter.Exporter.export\_rknn}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1270-L1294"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@try_export
def export_rknn(self, prefix=colorstr("RKNN:")):
    """Export YOLO model to RKNN format."""
...
### Method `ultralytics.engine.exporter.Exporter.export_saved_model` {#ultralytics.engine.exporter.Exporter.export\_saved\_model}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1046-L1111"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@try_export
def export_saved_model(self, prefix=colorstr("TensorFlow SavedModel:")):
    """Export YOLO model to TensorFlow SavedModel format."""
...
### Method `ultralytics.engine.exporter.Exporter.export_tfjs` {#ultralytics.engine.exporter.Exporter.export\_tfjs}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1258-L1267"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@try_export
def export_tfjs(self, prefix=colorstr("TensorFlow.js:")):
    """Export YOLO model to TensorFlow.js format."""
...
### Method `ultralytics.engine.exporter.Exporter.export_tflite` {#ultralytics.engine.exporter.Exporter.export\_tflite}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1121-L1134"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@try_export
def export_tflite(self, prefix=colorstr("TensorFlow Lite:")):
    """Export YOLO model to TensorFlow Lite format."""
...
### Method `ultralytics.engine.exporter.Exporter.export_torchscript` {#ultralytics.engine.exporter.Exporter.export\_torchscript}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L664-L678"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
@try_export
def export_torchscript(self, prefix=colorstr("TorchScript:")):
    """Export YOLO model to TorchScript format."""
...
### Method `ultralytics.engine.exporter.Exporter.get_int8_calibration_dataloader` {#ultralytics.engine.exporter.Exporter.get\_int8\_calibration\_dataloader}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L638-L661"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def get_int8_calibration_dataloader(self, prefix=""):
    """Build and return a dataloader for calibration of INT8 models."""
...
### Method `ultralytics.engine.exporter.Exporter.run_callbacks` {#ultralytics.engine.exporter.Exporter.run\_callbacks}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1457-L1460"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def run_callbacks(self, event: str):
    """Execute all callbacks for a given event."""
...
| Name | Description |
| --- | --- |
| [`forward`](#ultralytics.engine.exporter.IOSDetectModel.forward) | Normalize predictions of object detection model with input size-dependent factors. |

<details>
<summary>Source code in <code>ultralytics/engine/exporter.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1463-L1494"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.engine.exporter.IOSDetectModel.forward` {#ultralytics.engine.exporter.IOSDetectModel.forward}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1487-L1494"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def forward(self, x):
    """Normalize predictions of object detection model with input size-dependent factors."""
...
## Class `ultralytics.engine.exporter.NMSModel` {#ultralytics.engine.exporter.NMSModel}
...
| `args` | `SimpleNamespace` | The export arguments. | *required* |

**Methods**

| Name | Description |
| --- | --- |
| [`forward`](#ultralytics.engine.exporter.NMSModel.forward) | Perform inference with NMS post-processing. Supports Detect, Segment, OBB and Pose. |

<details>
<summary>Source code in <code>ultralytics/engine/exporter.py</code></summary>

<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1497-L1589"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
...
### Method `ultralytics.engine.exporter.NMSModel.forward` {#ultralytics.engine.exporter.NMSModel.forward}
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `x` | `torch.Tensor` | The preprocessed tensor with shape (B, C, H, W). | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L1513-L1589"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def forward(self, x):
    """Perform inference with NMS post-processing. Supports Detect, Segment, OBB and Pose.
...
## Function `ultralytics.engine.exporter.export_formats` {#ultralytics.engine.exporter.export\_formats}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L145-L181"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def export_formats():
    """Return a dictionary of Ultralytics YOLO export formats."""
    x = [
...
## Function `ultralytics.engine.exporter.best_onnx_opset` {#ultralytics.engine.exporter.best\_onnx\_opset}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L184-L209"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def best_onnx_opset(onnx, cuda=False) -> int:
    """Return max ONNX opset for this torch version with ONNX fallback."""
...
## Function `ultralytics.engine.exporter.validate_args` {#ultralytics.engine.exporter.validate\_args}
...
| `passed_args` | `SimpleNamespace` | The arguments used during export. | *required* |
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L212-L231"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def validate_args(format, passed_args, valid_args):
    """Validate arguments based on the export format.
...
## Function `ultralytics.engine.exporter.try_export` {#ultralytics.engine.exporter.try\_export}
...
<a href="https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L234-L254"><i class="fa-brands fa-github" aria-hidden="true" style="margin-right:6px;"></i>View on GitHub</a>
```python
def try_export(inner_func):
    """YOLO export decorator, i.e. @try_export."""
